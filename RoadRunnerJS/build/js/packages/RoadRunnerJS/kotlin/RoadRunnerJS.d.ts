...
export namespace path {
  class PathSegment {
    constructor(
      curve: path.ParametricCurve,
      interpolator: path.heading.HeadingInterpolator
    );
...
export namespace profile {
  const MotionProfileGenerator: {
    ...
    generateMotionProfile(
      start: profile.MotionState,
      goal: profile.MotionState,
      velocityConstraint: profile.VelocityConstraint,
      accelerationConstraint: profile.AccelerationConstraint,
      resolution: number
    ): profile.MotionProfile;
  };
}
...
export namespace trajectory {
  class DisplacementProducer {
    produce(val: number): number;
  }

  class DisplacementMarker {
    constructor(
      producer: trajectory.DisplacementProducer,
      callback: trajectory.MarkerCallback
    );
...
export namespace trajectory {
  ...
  class TemporalMarker {
    constructor(
      producer: trajectory.TimeProducer,
      callback: trajectory.MarkerCallback
    );
...
export namespace trajectory {
  class Trajectory {
    constructor(
      ...
      markers: Array<trajectory.TrajectoryMarker>
    );
...
export namespace trajectory {
  class TrajectoryBuilder {
    constructor(
      startPose: Nullable<geometry.Pose2d>,
      startTangent: Nullable<number>,
      trajectory: Nullable<trajectory.Trajectory>,
      t: Nullable<number>,
    ...
    lineTo(
      ...
      velConstraintOverride: trajectory.constraints.TrajectoryVelocityConstraint,
      accelConstraintOverride: trajectory.constraints.TrajectoryAccelerationConstraint
    ): trajectory.TrajectoryBuilder;
    lineToConstantHeading(
      endPosition: geometry.Vector2d,
      velConstraintOverride: Nullable<trajectory.constraints.TrajectoryVelocityConstraint>,
      accelConstraintOverride: Nullable<trajectory.constraints.TrajectoryAccelerationConstraint>
    ): trajectory.TrajectoryBuilder;
    lineToLinearHeading(
    ...
    buildTrajectory(
      path: path.Path,
      temporalMarkers: Array<trajectory.TemporalMarker>,
      displacementMarkers: Array<trajectory.DisplacementMarker>,
      spatialMarkers: Array<trajectory.SpatialMarker>
...
export namespace trajectory.constraints {
  class AngularVelocityConstraint extends trajectory.constraints
    .TrajectoryVelocityConstraint {
    constructor(maxAngularVel: number);
    get(
      s: number,
      pose: geometry.Pose2d,
      deriv: geometry.Pose2d,
      baseRobotVel: geometry.Pose2d
    ): number;
  }
}
export namespace trajectory.constraints {
  class MecanumVelocityConstraint extends trajectory.constraints
    .TrajectoryVelocityConstraint {
    constructor(
      maxWheelVel: number,
      trackWidth: number,
...
export namespace trajectory.constraints {
  class MinVelocityConstraint extends trajectory.constraints
    .TrajectoryVelocityConstraint {
    constructor(
      constraints: Array<trajectory.constraints.TrajectoryVelocityConstraint>
    );
    get(
      s: number,
      pose: geometry.Pose2d,
...
export namespace trajectory.constraints {
  class ProfileAccelerationConstraint extends trajectory.constraints
